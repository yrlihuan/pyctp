...
class CZQThostFtdcTradingAccountField:
    def __init__(self, FrozenTransferFee=0, Mortgage=0, ExchangeDeliveryMargin=0, FrozenMargin=0, WithdrawQuota=0, PositionProfit=0, BondRepurchaseValue=0, TransferFee=0, Commission=0, Interest=0, ShortSellingAmount=0, CashIn=0, AccountID="", Available=0, LowLimitRatio=0, PreCredit=0, PreMortgage=0, CreditRatio=0, MarginTradingAvail=0, CreditAmount=0, InterestBase=0, ExchangeMargin=0, ConversionAmount=0, SSStockValue=0, PreMargin=0, SettlementID=0, DeliveryMargin=0, TradingDay="", BrokerID="", FrozenCash=0, Withdraw=0, StampTax=0, Balance=0, FrozenStampTax=0, Reserve=0, PreDeposit=0, ShortSellingAvail=0, Credit=0, PreBalance=0, CurrMargin=0, FrozenCommission=0, CloseProfit=0, StockValue=0, MarginTradingAmount=0, Deposit=0):
        ...
        self.BondRepurchaseValue=BondRepurchaseValue
        ...
        self.vcmap={}
    def __repr__(self): return "<%s>" % ",".join(["%s:%s" % (x, getattr(self, x)) for x in ['FrozenTransferFee', 'Mortgage', 'ExchangeDeliveryMargin', 'FrozenMargin', 'WithdrawQuota', 'PositionProfit', 'BondRepurchaseValue', 'TransferFee', 'Commission', 'Interest', 'ShortSellingAmount', 'CashIn', 'AccountID', 'Available', 'LowLimitRatio', 'PreCredit', 'PreMortgage', 'CreditRatio', 'MarginTradingAvail', 'CreditAmount', 'InterestBase', 'ExchangeMargin', 'ConversionAmount', 'SSStockValue', 'PreMargin', 'SettlementID', 'DeliveryMargin', 'TradingDay', 'BrokerID', 'FrozenCash', 'Withdraw', 'StampTax', 'Balance', 'FrozenStampTax', 'Reserve', 'PreDeposit', 'ShortSellingAvail', 'Credit', 'PreBalance', 'CurrMargin', 'FrozenCommission', 'CloseProfit', 'StockValue', 'MarginTradingAmount', 'Deposit']])
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('FrozenTransferFee', u'冻结的过户费'),('Mortgage', u'质押金额'),('ExchangeDeliveryMargin', u'交易所交割保证金'),('FrozenMargin', u'冻结的保证金'),('WithdrawQuota', u'可取资金'),('PositionProfit', u'融资持仓盈亏'),('BondRepurchaseValue', u'国债回购占用资金'),('TransferFee', u'过户费'),('Commission', u'手续费'),('Interest', u'利息收入'),('ShortSellingAmount', u'融券卖出金额'),('CashIn', u'资金差额'),('AccountID', u'投资者帐号'),('Available', u'现金'),('LowLimitRatio', u'最低维持担保比例'),('PreCredit', u'上次信用额度'),('PreMortgage', u'上次质押金额'),('CreditRatio', u'维持担保比例'),('MarginTradingAvail', u'融资买入可用金额'),('CreditAmount', u'授信额度'),('InterestBase', u'利息基数'),('ExchangeMargin', u'交易所保证金'),('ConversionAmount', u'折算金额'),('SSStockValue', u'融券总市值'),('PreMargin', u'上次占用的保证金'),('SettlementID', u'结算编号'),('DeliveryMargin', u'投资者交割保证金'),('TradingDay', u'交易日'),('BrokerID', u'经纪公司代码'),('FrozenCash', u'冻结的资金'),('Withdraw', u'出金金额'),('StampTax', u'印花税'),('Balance', u'期货结算准备金'),('FrozenStampTax', u'冻结的印花税'),('Reserve', u'基本准备金'),('PreDeposit', u'上次存款额'),('ShortSellingAvail', u'融券卖出可用金额'),('Credit', u'保证金可用余额'),('PreBalance', u'上次结算准备金'),('CurrMargin', u'当前保证金总额'),('FrozenCommission', u'冻结的手续费'),('CloseProfit', u'融券持仓盈亏'),('StockValue', u'证券总价值'),('MarginTradingAmount', u'融资买入金额'),('Deposit', u'入金金额')]])
    def getval(self, n):
        if n in []:
            return self.vcmap[n][getattr(self, n)].encode("utf-8")
        else: return getattr(self, n)
...
class CZQThostFtdcTradeField:
    def __init__(self, TradeType='0', TraderID="", HedgeFlag='1', TradeTime="", Direction='0', ParticipantID="", Price="", ClientID="", Volume=0, OrderSysID="", ClearingPartID="", InstrumentID="", ExchangeID="", SettlementID=0, UserID="", TradingDay="", BrokerID="", OffsetFlag='0', OrderLocalID="", TradeID="", TradeDate="", BusinessUnit="", SequenceNo=0, OrderRef="", BrokerOrderSeq=0, InvestorID="", ExchangeInstID="", PriceSource='0', TradingRole='1'):
        ...
        self.vcmap={'Direction': {"'9'": u'\u76f4\u63a5\u8fd8\u5238', "'b'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u51fa\u4fe1\u7528\u8d26\u6237', "'7'": u'\u4e70\u5238\u8fd8\u5238', "'8'": u'\u76f4\u63a5\u8fd8\u6b3e', "'5'": u'\u878d\u5238\u5356\u51fa', "'c'": u'\u73b0\u91d1\u66ff\u4ee3\uff0c\u53ea\u7528\u4f5c\u56de\u62a5', "'4'": u'\u878d\u8d44\u4e70\u5165', "'1'": u'\u5356', "'0'": u'\u4e70', "'6'": u'\u5356\u5238\u8fd8\u6b3e', "'2'": u'ETF\u7533\u8d2d', "'3'": u'ETF\u8d4e\u56de', "'a'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u5165\u4fe1\u7528\u8d26\u6237'}, 'TradeType': {"'5'": u'ETF\u7533\u8d2d', "'4'": u'\u7ec4\u5408\u884d\u751f\u6210\u4ea4', "'1'": u'\u671f\u6743\u6267\u884c', "'0'": u'\u666e\u901a\u6210\u4ea4', "'6'": u'ETF\u8d4e\u56de', "'2'": u'OTC\u6210\u4ea4', "'3'": u'\u671f\u8f6c\u73b0\u884d\u751f\u6210\u4ea4'}, 'OffsetFlag': {"'5'": u'\u5f3a\u51cf', "'4'": u'\u5e73\u6628', "'1'": u'\u5e73\u4ed3', "'0'": u'\u5f00\u4ed3', "'6'": u'\u672c\u5730\u5f3a\u5e73', "'2'": u'\u5f3a\u5e73', "'3'": u'\u5e73\u4eca'}, 'HedgeFlag': {"'1'": u'\u6295\u673a', "'3'": u'\u5957\u4fdd'}, 'PriceSource': {"'1'": u'\u4e70\u59d4\u6258\u4ef7', "'2'": u'\u5356\u59d4\u6258\u4ef7', "'0'": u'\u524d\u6210\u4ea4\u4ef7'}, 'TradingRole': {"'1'": u'\u4ee3\u7406', "'2'": u'\u81ea\u8425', "'3'": u'\u505a\u5e02\u5546'}}
...
class CZQThostFtdcReqOpenAccountField:
    ...
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('MoneyAccountStatus', u'资金账户状态'),('BrokerBranchID', u'期商分支机构代码'),('BankPassWord', u'银行密码'),('Telephone', u'电话号码'),('TradeTime', u'交易时间'),('VerifyCertNoFlag', u'验证客户证件号码标志'),('TID', u'交易ID'),('AccountID', u'投资者帐号'),('BankAccount', u'银行帐号'),('Fax', u'传真'),('InstallID', u'安装编号'),('CustomerName', u'客户姓名'),('CountryCode', u'国家代码'),('TradeCode', u'业务功能码'),('BankSecuAcc', u'期货单位帐号'),('BankBranchID', u'银行分支机构代码'),('SessionID', u'会话号'),('Address', u'地址'),('PlateSerial', u'银期平台消息流水号'),('BankPwdFlag', u'银行密码标志'),('CustType', u'客户类型'),('IdentifiedCardNo', u'证件号码'),('BankID', u'银行代码'),('BankSerial', u'银行流水号'),('OperNo', u'交易柜员'),('TradingDay', u'交易系统日期'),('Gender', u'性别'),('BrokerID', u'期商代码'),('CashExchangeCode', u'汇钞标志'),('IdCardType', u'证件类型'),('Password', u'期货密码'),('MobilePhone', u'手机'),('TradeDate', u'交易日期'),('CurrencyID', u'币种代码'),('BankAccType', u'银行帐号类型'),('LastFragment', u'最后分片标志'),('ZipCode', u'邮编'),('BankSecuAccType', u'期货单位帐号类型'),('BrokerIDByBank', u'期货公司银行编码'),('SecuPwdFlag', u'期货资金密码核对标志'),('EMail', u'电子邮件'),('Digest', u'摘要'),('DeviceID', u'渠道标志')]])
    def getval(self, n):
...
class CZQThostFtdcLoginInfoField:
    ...
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('MacAddress', u'Mac地址'),('MaxOrderRef', u'最大报单引用'),('UserProductInfo', u'用户端产品信息'),('InterfaceProductInfo', u'接口端产品信息'),('UserID', u'用户代码'),('LoginDate', u'登录日期'),('SystemName', u'系统名称'),('SessionID', u'会话编号'),('BrokerID', u'经纪公司代码'),('OneTimePassword', u'动态密码'),('FrontID', u'前置编号'),('Password', u'密码'),('IPAddress', u'IP地址'),('LoginTime', u'登录时间'),('ProtocolInfo', u'协议信息')]])
    def getval(self, n):
        if n in []:
            return self.vcmap[n][getattr(self, n)].encode("utf-8")
        else: return getattr(self, n)
...
class CZQThostFtdcTraderField:
    ...
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('ExchangeID', u'交易所代码'),('ParticipantID', u'会员代码'),('BranchID', u'营业部编号'),('TraderID', u'交易所交易员代码'),('BrokerID', u'经纪公司代码'),('InstallCount', u'安装数量'),('Password', u'密码')]])
    def getval(self, n):
        if n in []:
            return self.vcmap[n][getattr(self, n)].encode("utf-8")
        else: return getattr(self, n)
...
class CZQThostFtdcQryInstrumentMarginRateField:
    ...
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('InstrumentID', u'合约代码'),('InvestorID', u'投资者代码'),('ExchangeID', u'交易所代码'),('BrokerID', u'经纪公司代码'),('HedgeFlag', u'投机套保标志')]])
    def getval(self, n):
        if n in ['HedgeFlag']:
            return self.vcmap[n][getattr(self, n)].encode("utf-8")
        else: return getattr(self, n)
...
class CZQThostFtdcQueryMaxOrderVolumeWithPriceField:
    def __init__(self, InstrumentID="", Direction='0', OffsetFlag='0', Price=0, HedgeFlag='1', InvestorID="", BrokerID="", MaxVolume=0):
        ...
        self.vcmap={'Direction': {"'9'": u'\u76f4\u63a5\u8fd8\u5238', "'b'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u51fa\u4fe1\u7528\u8d26\u6237', "'7'": u'\u4e70\u5238\u8fd8\u5238', "'8'": u'\u76f4\u63a5\u8fd8\u6b3e', "'5'": u'\u878d\u5238\u5356\u51fa', "'c'": u'\u73b0\u91d1\u66ff\u4ee3\uff0c\u53ea\u7528\u4f5c\u56de\u62a5', "'4'": u'\u878d\u8d44\u4e70\u5165', "'1'": u'\u5356', "'0'": u'\u4e70', "'6'": u'\u5356\u5238\u8fd8\u6b3e', "'2'": u'ETF\u7533\u8d2d', "'3'": u'ETF\u8d4e\u56de', "'a'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u5165\u4fe1\u7528\u8d26\u6237'}, 'HedgeFlag': {"'1'": u'\u6295\u673a', "'3'": u'\u5957\u4fdd'}, 'OffsetFlag': {"'5'": u'\u5f3a\u51cf', "'4'": u'\u5e73\u6628', "'1'": u'\u5e73\u4ed3', "'0'": u'\u5f00\u4ed3', "'6'": u'\u672c\u5730\u5f3a\u5e73', "'2'": u'\u5f3a\u5e73', "'3'": u'\u5e73\u4eca'}}
...
class CZQThostFtdcCombinationLegField:
    def __init__(self, Direction='0', ImplyLevel=0, LegMultiple=0, LegID=0, LegInstrumentID="", CombInstrumentID=""):
        ...
        self.vcmap={'Direction': {"'9'": u'\u76f4\u63a5\u8fd8\u5238', "'b'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u51fa\u4fe1\u7528\u8d26\u6237', "'7'": u'\u4e70\u5238\u8fd8\u5238', "'8'": u'\u76f4\u63a5\u8fd8\u6b3e', "'5'": u'\u878d\u5238\u5356\u51fa', "'c'": u'\u73b0\u91d1\u66ff\u4ee3\uff0c\u53ea\u7528\u4f5c\u56de\u62a5', "'4'": u'\u878d\u8d44\u4e70\u5165', "'1'": u'\u5356', "'0'": u'\u4e70', "'6'": u'\u5356\u5238\u8fd8\u6b3e', "'2'": u'ETF\u7533\u8d2d', "'3'": u'ETF\u8d4e\u56de', "'a'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u5165\u4fe1\u7528\u8d26\u6237'}}
...
class CZQThostFtdcSyncingTradingCodeField:
    ...
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('InvestorID', u'投资者代码'),('ExchangeID', u'交易所代码'),('BrokerID', u'经纪公司代码'),('IsActive', u'是否活跃'),('ClientID', u'客户代码')]])
    def getval(self, n):
        if n in []:
            return self.vcmap[n][getattr(self, n)].encode("utf-8")
        else: return getattr(self, n)
class CZQThostFtdcInstrumentTradingRightField:
    def __init__(self, InstrumentID="", Direction='0', InstrumentRange='1', TradingRight='0', ExchangeID="", InvestorID="", BrokerID="", InvestorRange='1'):
        ...
        self.BrokerID=BrokerID
        self.InvestorRange=InvestorRange
        self.vcmap={'Direction': {"'9'": u'\u76f4\u63a5\u8fd8\u5238', "'b'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u51fa\u4fe1\u7528\u8d26\u6237', "'7'": u'\u4e70\u5238\u8fd8\u5238', "'8'": u'\u76f4\u63a5\u8fd8\u6b3e', "'5'": u'\u878d\u5238\u5356\u51fa', "'c'": u'\u73b0\u91d1\u66ff\u4ee3\uff0c\u53ea\u7528\u4f5c\u56de\u62a5', "'4'": u'\u878d\u8d44\u4e70\u5165', "'1'": u'\u5356', "'0'": u'\u4e70', "'6'": u'\u5356\u5238\u8fd8\u6b3e', "'2'": u'ETF\u7533\u8d2d', "'3'": u'ETF\u8d4e\u56de', "'a'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u5165\u4fe1\u7528\u8d26\u6237'}, 'InstrumentRange': {"'1'": u'\u6240\u6709', "'2'": u'\u4ea7\u54c1', "'3'": u'\u80a1\u7968\u6743\u9650\u6a21\u7248', "'4'": u'\u80a1\u7968'}, 'InvestorRange': {"'1'": u'\u6240\u6709', "'2'": u'\u6295\u8d44\u8005\u7ec4', "'3'": u'\u5355\u4e00\u6295\u8d44\u8005'}, 'TradingRight': {"'2'": u'\u4e0d\u80fd\u4ea4\u6613', "'0'": u'\u53ef\u4ee5\u4ea4\u6613'}}
    ...
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('InstrumentID', u'合约代码'),('Direction', u'买卖'),('InstrumentRange', u'股票权限分类'),('TradingRight', u'交易权限'),('ExchangeID', u'交易所代码'),('InvestorID', u'投资者代码'),('BrokerID', u'经纪公司代码'),('InvestorRange', u'投资者范围')]])
    def getval(self, n):
        if n in ['Direction', 'InstrumentRange', 'TradingRight', 'InvestorRange']:
            return self.vcmap[n][getattr(self, n)].encode("utf-8")
        else: return getattr(self, n)
class CZQThostFtdcInvestorPositionDetailField:
    def __init__(self, ExchMargin=0, TradeType='0', HedgeFlag='1', TransferFee=0, Commission=0, Direction='0', CloseAmount=0, OpenPrice=0, Volume=0, LastSettlementPrice=0, CloseVolume=0, InstrumentID="", ExchangeID="", SettlementID=0, TradingDay="", Amount=0, BrokerID="", StampTax=0, Margin=0, TradeID="", SettlementPrice=0, InvestorID="", OpenDate=""):
        ...
        self.InvestorID=InvestorID
        self.OpenDate=OpenDate
        self.vcmap={'Direction': {"'9'": u'\u76f4\u63a5\u8fd8\u5238', "'b'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u51fa\u4fe1\u7528\u8d26\u6237', "'7'": u'\u4e70\u5238\u8fd8\u5238', "'8'": u'\u76f4\u63a5\u8fd8\u6b3e', "'5'": u'\u878d\u5238\u5356\u51fa', "'c'": u'\u73b0\u91d1\u66ff\u4ee3\uff0c\u53ea\u7528\u4f5c\u56de\u62a5', "'4'": u'\u878d\u8d44\u4e70\u5165', "'1'": u'\u5356', "'0'": u'\u4e70', "'6'": u'\u5356\u5238\u8fd8\u6b3e', "'2'": u'ETF\u7533\u8d2d', "'3'": u'ETF\u8d4e\u56de', "'a'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u5165\u4fe1\u7528\u8d26\u6237'}, 'TradeType': {"'5'": u'ETF\u7533\u8d2d', "'4'": u'\u7ec4\u5408\u884d\u751f\u6210\u4ea4', "'1'": u'\u671f\u6743\u6267\u884c', "'0'": u'\u666e\u901a\u6210\u4ea4', "'6'": u'ETF\u8d4e\u56de', "'2'": u'OTC\u6210\u4ea4', "'3'": u'\u671f\u8f6c\u73b0\u884d\u751f\u6210\u4ea4'}, 'HedgeFlag': {"'1'": u'\u6295\u673a', "'3'": u'\u5957\u4fdd'}}
    def __repr__(self): return "<%s>" % ",".join(["%s:%s" % (x, getattr(self, x)) for x in ['ExchMargin', 'TradeType', 'HedgeFlag', 'TransferFee', 'Commission', 'Direction', 'CloseAmount', 'OpenPrice', 'Volume', 'LastSettlementPrice', 'CloseVolume', 'InstrumentID', 'ExchangeID', 'SettlementID', 'TradingDay', 'Amount', 'BrokerID', 'StampTax', 'Margin', 'TradeID', 'SettlementPrice', 'InvestorID', 'OpenDate']])
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('ExchMargin', u'交易所保证金'),('TradeType', u'成交类型'),('HedgeFlag', u'投机套保标志'),('TransferFee', u'过户费'),('Commission', u'手续费'),('Direction', u'买卖'),('CloseAmount', u'平仓金额'),('OpenPrice', u'开仓价'),('Volume', u'数量'),('LastSettlementPrice', u'昨结算价'),('CloseVolume', u'平仓量'),('InstrumentID', u'合约代码'),('ExchangeID', u'交易所代码'),('SettlementID', u'结算编号'),('TradingDay', u'交易日'),('Amount', u'融资融券金额'),('BrokerID', u'经纪公司代码'),('StampTax', u'印花税'),('Margin', u'投资者保证金'),('TradeID', u'成交编号'),('SettlementPrice', u'结算价'),('InvestorID', u'投资者代码'),('OpenDate', u'开仓日期')]])
    def getval(self, n):
...
class CZQThostFtdcInstrumentCommissionRateField:
    def __init__(self, InstrumentID="", Direction='0', TradeFeeByMoney=0, MinTradeFee=0, StampTaxRateByMoney=0, InvestorID="", MarginByMoney=0, StampTaxRateByVolume=0, BrokerID="", InvestorRange='1', TransferFeeRateByVolume=0, TransferFeeRateByMoney=0, TradeFeeByVolume=0):
        self.InstrumentID=InstrumentID
        self.Direction=Direction
        ...
        self.vcmap={'Direction': {"'9'": u'\u76f4\u63a5\u8fd8\u5238', "'b'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u51fa\u4fe1\u7528\u8d26\u6237', "'7'": u'\u4e70\u5238\u8fd8\u5238', "'8'": u'\u76f4\u63a5\u8fd8\u6b3e', "'5'": u'\u878d\u5238\u5356\u51fa', "'c'": u'\u73b0\u91d1\u66ff\u4ee3\uff0c\u53ea\u7528\u4f5c\u56de\u62a5', "'4'": u'\u878d\u8d44\u4e70\u5165', "'1'": u'\u5356', "'0'": u'\u4e70', "'6'": u'\u5356\u5238\u8fd8\u6b3e', "'2'": u'ETF\u7533\u8d2d', "'3'": u'ETF\u8d4e\u56de', "'a'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u5165\u4fe1\u7528\u8d26\u6237'}, 'InvestorRange': {"'1'": u'\u6240\u6709', "'2'": u'\u6295\u8d44\u8005\u7ec4', "'3'": u'\u5355\u4e00\u6295\u8d44\u8005'}}
    def __repr__(self): return "<%s>" % ",".join(["%s:%s" % (x, getattr(self, x)) for x in ['InstrumentID', 'Direction', 'TradeFeeByMoney', 'MinTradeFee', 'StampTaxRateByMoney', 'InvestorID', 'MarginByMoney', 'StampTaxRateByVolume', 'BrokerID', 'InvestorRange', 'TransferFeeRateByVolume', 'TransferFeeRateByMoney', 'TradeFeeByVolume']])
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('InstrumentID', u'合约代码'),('Direction', u'买卖方向'),('TradeFeeByMoney', u'交易费'),('MinTradeFee', u'最小过户费'),('StampTaxRateByMoney', u'印花税率'),('InvestorID', u'投资者代码'),('MarginByMoney', u'交易附加费率'),('StampTaxRateByVolume', u'印花税率(按手数)'),('BrokerID', u'经纪公司代码'),('InvestorRange', u'投资者范围'),('TransferFeeRateByVolume', u'过户费率(按手数)'),('TransferFeeRateByMoney', u'过户费率'),('TradeFeeByVolume', u'交易费(按手数)')]])
    def getval(self, n):
...
class CZQThostFtdcQryTradingCodeField:
    ...
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('InvestorID', u'投资者代码'),('ExchangeID', u'交易所代码'),('BrokerID', u'经纪公司代码'),('ClientID', u'客户代码')]])
    def getval(self, n):
        if n in []:
            return self.vcmap[n][getattr(self, n)].encode("utf-8")
        else: return getattr(self, n)
...
class CZQThostFtdcSpecificInstrumentField:
    ...
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('InstrumentID', u'合约代码'),('ExchangeID', u'交易所代码')]])
    def getval(self, n):
        if n in []:
            return self.vcmap[n][getattr(self, n)].encode("utf-8")
        else: return getattr(self, n)
...
class CZQThostFtdcReqChangeAccountField:
    ...
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('MoneyAccountStatus', u'资金账户状态'),('NewBankPassWord', u'新银行密码'),('BrokerBranchID', u'期商分支机构代码'),('BankPassWord', u'银行密码'),('Telephone', u'电话号码'),('TradeTime', u'交易时间'),('VerifyCertNoFlag', u'验证客户证件号码标志'),('TID', u'交易ID'),('AccountID', u'投资者帐号'),('BankAccount', u'银行帐号'),('Fax', u'传真'),('InstallID', u'安装编号'),('CustomerName', u'客户姓名'),('CountryCode', u'国家代码'),('TradeCode', u'业务功能码'),('BankBranchID', u'银行分支机构代码'),('SessionID', u'会话号'),('NewBankAccount', u'新银行帐号'),('Address', u'地址'),('PlateSerial', u'银期平台消息流水号'),('BankPwdFlag', u'银行密码标志'),('CustType', u'客户类型'),('IdentifiedCardNo', u'证件号码'),('BankID', u'银行代码'),('BankSerial', u'银行流水号'),('TradingDay', u'交易系统日期'),('Gender', u'性别'),('BrokerID', u'期商代码'),('IdCardType', u'证件类型'),('Password', u'期货密码'),('MobilePhone', u'手机'),('TradeDate', u'交易日期'),('CurrencyID', u'币种代码'),('BankAccType', u'银行帐号类型'),('LastFragment', u'最后分片标志'),('ZipCode', u'邮编'),('BrokerIDByBank', u'期货公司银行编码'),('SecuPwdFlag', u'期货资金密码核对标志'),('EMail', u'电子邮件'),('Digest', u'摘要')]])
    def getval(self, n):
...
class CZQThostFtdcMaxStockPositionAmountField:
    def __init__(self, InstrumentID="", InvestorID="", BrokerID="", MaxAmount=0):
        self.InstrumentID=InstrumentID
        self.InvestorID=InvestorID
        self.BrokerID=BrokerID
        self.MaxAmount=MaxAmount
        self.vcmap={}
    def __repr__(self): return "<%s>" % ",".join(["%s:%s" % (x, getattr(self, x)) for x in ['InstrumentID', 'InvestorID', 'BrokerID', 'MaxAmount']])
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('InstrumentID', u'合约代码'),('InvestorID', u'投资者代码'),('BrokerID', u'经纪公司代码'),('MaxAmount', u'最大持仓数量')]])
    def getval(self, n):
        if n in []:
            return self.vcmap[n][getattr(self, n)].encode("utf-8")
        else: return getattr(self, n)
...
class CZQThostFtdcParkedOrderField:
    def __init__(self, ContingentCondition='1', CombOffsetFlag="", UserID="", LimitPrice="", UserForceClose=0, Status='1', Direction='0', UserType='0', VolumeTotalOriginal=0, OrderPriceType='1', TimeCondition='1', IsAutoSuspend=0, StopPrice=0, InstrumentID="", ExchangeID="", MinVolume=0, ForceCloseReason='0', ErrorID=0, ParkedOrderID="", BrokerID="", CombHedgeFlag="", GTDDate="", BusinessUnit="", ErrorMsg="", OrderRef="", InvestorID="", VolumeCondition='1', RequestID=0):
        ...
        self.VolumeCondition=VolumeCondition
        self.RequestID=RequestID
        self.vcmap={'Status': {"'1'": u'\u672a\u53d1\u9001', "'2'": u'\u5df2\u53d1\u9001', "'3'": u'\u5df2\u5220\u9664'}, 'ContingentCondition': {"'9'": u'\u5356\u4e00\u4ef7\u5927\u4e8e\u6761\u4ef6\u4ef7', "'B'": u'\u5356\u4e00\u4ef7\u5c0f\u4e8e\u6761\u4ef6\u4ef7', "'7'": u'\u6700\u65b0\u4ef7\u5c0f\u4e8e\u6761\u4ef6\u4ef7', "'8'": u'\u6700\u65b0\u4ef7\u5c0f\u4e8e\u7b49\u4e8e\u6761\u4ef6\u4ef7', "'5'": u'\u6700\u65b0\u4ef7\u5927\u4e8e\u6761\u4ef6\u4ef7', "'C'": u'\u5356\u4e00\u4ef7\u5c0f\u4e8e\u7b49\u4e8e\u6761\u4ef6\u4ef7', "'4'": u'\u9884\u57cb\u5355', "'1'": u'\u7acb\u5373', "'6'": u'\u6700\u65b0\u4ef7\u5927\u4e8e\u7b49\u4e8e\u6761\u4ef6\u4ef7', "'2'": u'\u6b62\u635f', "'H'": u'\u4e70\u4e00\u4ef7\u5c0f\u4e8e\u7b49\u4e8e\u6761\u4ef6\u4ef7', "'E'": u'\u4e70\u4e00\u4ef7\u5927\u4e8e\u7b49\u4e8e\u6761\u4ef6\u4ef7', "'3'": u'\u6b62\u8d62', "'D'": u'\u4e70\u4e00\u4ef7\u5927\u4e8e\u6761\u4ef6\u4ef7', "'A'": u'\u5356\u4e00\u4ef7\u5927\u4e8e\u7b49\u4e8e\u6761\u4ef6\u4ef7', "'F'": u'\u4e70\u4e00\u4ef7\u5c0f\u4e8e\u6761\u4ef6\u4ef7'}, 'Direction': {"'9'": u'\u76f4\u63a5\u8fd8\u5238', "'b'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u51fa\u4fe1\u7528\u8d26\u6237', "'7'": u'\u4e70\u5238\u8fd8\u5238', "'8'": u'\u76f4\u63a5\u8fd8\u6b3e', "'5'": u'\u878d\u5238\u5356\u51fa', "'c'": u'\u73b0\u91d1\u66ff\u4ee3\uff0c\u53ea\u7528\u4f5c\u56de\u62a5', "'4'": u'\u878d\u8d44\u4e70\u5165', "'1'": u'\u5356', "'0'": u'\u4e70', "'6'": u'\u5356\u5238\u8fd8\u6b3e', "'2'": u'ETF\u7533\u8d2d', "'3'": u'ETF\u8d4e\u56de', "'a'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u5165\u4fe1\u7528\u8d26\u6237'}, 'UserType': {"'1'": u'\u64cd\u4f5c\u5458', "'2'": u'\u7ba1\u7406\u5458', "'0'": u'\u6295\u8d44\u8005'}, 'ForceCloseReason': {"'5'": u'\u8fdd\u89c4', "'4'": u'\u6301\u4ed3\u975e\u6574\u6570\u500d', "'1'": u'\u8d44\u91d1\u4e0d\u8db3', "'0'": u'\u975e\u5f3a\u5e73', "'6'": u'\u5176\u5b83', "'2'": u'\u5ba2\u6237\u8d85\u4ed3', "'3'": u'\u4f1a\u5458\u8d85\u4ed3'}, 'OrderPriceType': {"'9'": u'\u5356\u4e00\u4ef7\u6d6e\u52a8\u4e0a\u6d6e1\u4e2aticks', "'B'": u'\u5356\u4e00\u4ef7\u6d6e\u52a8\u4e0a\u6d6e3\u4e2aticks', "'W'": u'\u5f00\u653e\u5f0f\u57fa\u91d1\u8d4e\u56de', "'U'": u'\u6743\u8bc1\u884c\u6743', "'Q'": u'\u8981\u7ea6\u6536\u8d2d\u64a4\u9500', "'L'": u'\u6307\u5b9a\u64a4\u9500', "'H'": u'\u6ce8\u9500A\u80a1\u7f51\u7edc\u5bc6\u7801\u670d\u52a1\u4ee3\u7801', "'N'": u'\u8bc1\u5238\u53c2\u4e0e\u7533\u8d2d', "'S'": u'\u53ef\u8f6c\u503a\u8f6c\u6362\u767b\u8bb0', "'d'": u'ETF\u7533\u8d2d', "'J'": u'\u6ce8\u9500B\u80a1\u7f51\u7edc\u5bc6\u7801\u670d\u52a1\u4ee3\u7801', "'f'": u'\u8bc1\u5238\u516c\u53f8\u878d\u5238\u4e13\u7528\u8d26\u6237\u8fc7\u6237\u5230\u8bc1\u5238\u516c\u53f8\u4fe1\u7528\u4ea4\u6613\u62c5\u4fdd\u8bc1\u5238\u8d26\u6237', "'7'": u'\u6700\u65b0\u4ef7\u6d6e\u52a8\u4e0a\u6d6e3\u4e2aticks', "'X'": u'\u5f00\u653e\u5f0f\u57fa\u91d1\u8ba4\u8d2d', "'5'": u'\u6700\u65b0\u4ef7\u6d6e\u52a8\u4e0a\u6d6e1\u4e2aticks', "'c'": u'\u503a\u5238\u51fa\u5e93', "'1'": u'\u4efb\u610f\u4ef7', "'Z'": u'\u5f00\u653e\u5f0f\u57fa\u91d1\u8bbe\u7f6e\u5206\u7ea2\u65b9\u5f0f', "'i'": u'\u8bc1\u5238\u516c\u53f8\u878d\u5238\u4e13\u7528\u8d26\u6237\u8fc7\u6237\u5230\u8bc1\u5238\u516c\u53f8\u81ea\u8425\u8d26\u6237', "'3'": u'\u6700\u4f18\u4ef7', "'D'": u'\u4e70\u4e00\u4ef7\u6d6e\u52a8\u4e0a\u6d6e1\u4e2aticks', "'F'": u'\u4e70\u4e00\u4ef7\u6d6e\u52a8\u4e0a\u6d6e3\u4e2aticks', "'8'": u'\u5356\u4e00\u4ef7', "'C'": u'\u4e70\u4e00\u4ef7', "'T'": u'\u53ef\u8f6c\u503a\u56de\u552e\u767b\u8bb0', "'O'": u'\u8bc1\u5238\u53c2\u4e0e\u914d\u80a1', "'P'": u'\u8981\u7ea6\u6536\u8d2d\u767b\u8bb0', "'M'": u'\u6307\u5b9a\u767b\u8bb0', "'V'": u'\u5f00\u653e\u5f0f\u57fa\u91d1\u7533\u8d2d', "'I'": u'\u6fc0\u6d3bB\u80a1\u7f51\u7edc\u5bc6\u7801\u670d\u52a1\u4ee3\u7801', "'R'": u'\u8bc1\u5238\u6295\u7968', "'g'": u'\u8bc1\u5238\u516c\u53f8\u4fe1\u7528\u4ea4\u6613\u62c5\u4fdd\u8bc1\u5238\u8d26\u6237\u8fc7\u6237\u5230\u8bc1\u5238\u516c\u53f8\u878d\u5238\u4e13\u7528\u8d26\u6237', "'e'": u'ETF\u8d4e\u56de', "'a'": u'\u5f00\u653e\u5f0f\u57fa\u91d1\u8f6c\u6362\u4e3a\u5176\u4ed6\u57fa\u91d1', "'K'": u'\u56de\u8d2d\u6ce8\u9500', "'Y'": u'\u5f00\u653e\u5f0f\u57fa\u91d1\u8f6c\u6258\u7ba1\u8f6c\u51fa', "'b'": u'\u503a\u5238\u5165\u5e93', "'4'": u'\u6700\u65b0\u4ef7', "'6'": u'\u6700\u65b0\u4ef7\u6d6e\u52a8\u4e0a\u6d6e2\u4e2aticks', "'2'": u'\u9650\u4ef7', "'G'": u'\u6fc0\u6d3bA\u80a1\u7f51\u7edc\u5bc6\u7801\u670d\u52a1\u4ee3\u7801', "'h'": u'\u6295\u8d44\u8005\u666e\u901a\u8bc1\u5238\u8d26\u6237\u8fc7\u6237\u5230\u8bc1\u5238\u516c\u53f8\u4fe1\u7528\u4ea4\u6613\u62c5\u4fdd\u8bc1\u5238\u8d26\u6237', "'E'": u'\u4e70\u4e00\u4ef7\u6d6e\u52a8\u4e0a\u6d6e2\u4e2aticks', "'A'": u'\u5356\u4e00\u4ef7\u6d6e\u52a8\u4e0a\u6d6e2\u4e2aticks'}, 'VolumeCondition': {"'1'": u'\u4efb\u4f55\u6570\u91cf', "'2'": u'\u6700\u5c0f\u6570\u91cf', "'3'": u'\u5168\u90e8\u6570\u91cf'}, 'TimeCondition': {"'5'": u'\u64a4\u9500\u524d\u6709\u6548', "'4'": u'\u6307\u5b9a\u65e5\u671f\u524d\u6709\u6548', "'1'": u'\u7acb\u5373\u5b8c\u6210\uff0c\u5426\u5219\u64a4\u9500', "'6'": u'\u96c6\u5408\u7ade\u4ef7\u6709\u6548', "'2'": u'\u672c\u8282\u6709\u6548', "'3'": u'\u5f53\u65e5\u6709\u6548'}}
...
class CZQThostFtdcInvestorPositionCombineDetailField:
    def __init__(self, InstrumentID="", ExchangeID="", MarginRateByVolume=0, ComTradeID="", SettlementID=0, InvestorID="", TotalAmt=0, Margin=0, ExchMargin=0, LegMultiple=0, HedgeFlag='1', TradeID="", LegID=0, TradingDay="", MarginRateByMoney=0, Direction='0', BrokerID="", CombInstrumentID="", OpenDate=""):
        ...
        self.CombInstrumentID=CombInstrumentID
        self.OpenDate=OpenDate
        self.vcmap={'Direction': {"'9'": u'\u76f4\u63a5\u8fd8\u5238', "'b'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u51fa\u4fe1\u7528\u8d26\u6237', "'7'": u'\u4e70\u5238\u8fd8\u5238', "'8'": u'\u76f4\u63a5\u8fd8\u6b3e', "'5'": u'\u878d\u5238\u5356\u51fa', "'c'": u'\u73b0\u91d1\u66ff\u4ee3\uff0c\u53ea\u7528\u4f5c\u56de\u62a5', "'4'": u'\u878d\u8d44\u4e70\u5165', "'1'": u'\u5356', "'0'": u'\u4e70', "'6'": u'\u5356\u5238\u8fd8\u6b3e', "'2'": u'ETF\u7533\u8d2d', "'3'": u'ETF\u8d4e\u56de', "'a'": u'\u62c5\u4fdd\u54c1\u5212\u8f6c\u5165\u4fe1\u7528\u8d26\u6237'}, 'HedgeFlag': {"'1'": u'\u6295\u673a', "'3'": u'\u5957\u4fdd'}}
...
dcRspFutureSignIn=CZQThostFtdcRspFutureSignInField
dcQryTradingNotice=CZQThostFtdcQryTradingNoticeField
dcTradingAccount=CZQThostFtdcTradingAccountField
dcAuthenticationInfo=CZQThostFtdcAuthenticationInfoField
dcBrokerTradingParams=CZQThostFtdcBrokerTradingParamsField
dcQryBroker=CZQThostFtdcQryBrokerField
dcTrade=CZQThostFtdcTradeField
dcQryExchange=CZQThostFtdcQryExchangeField
dcQrySettlementInfo=CZQThostFtdcQrySettlementInfoField
dcReqDayEndFileReady=CZQThostFtdcReqDayEndFileReadyField
dcSyncingInvestor=CZQThostFtdcSyncingInvestorField
dcCFMMCTradingAccountKey=CZQThostFtdcCFMMCTradingAccountKeyField
dcQrySyncStatus=CZQThostFtdcQrySyncStatusField
dcQryInvestorPositionDetail=CZQThostFtdcQryInvestorPositionDetailField
dcTransferBank=CZQThostFtdcTransferBankField
dcOrderAction=CZQThostFtdcOrderActionField
dcQryBrokerUserEvent=CZQThostFtdcQryBrokerUserEventField
dcReqRepeal=CZQThostFtdcReqRepealField
dcTransferSerial=CZQThostFtdcTransferSerialField
dcInvestorWithdrawAlgorithm=CZQThostFtdcInvestorWithdrawAlgorithmField
dcUserLogout=CZQThostFtdcUserLogoutField
dcBrokerUserEvent=CZQThostFtdcBrokerUserEventField
dcVerifyInvestorPassword=CZQThostFtdcVerifyInvestorPasswordField
dcRspQueryTradeResultBySerial=CZQThostFtdcRspQueryTradeResultBySerialField
dcQryParkedOrder=CZQThostFtdcQryParkedOrderField
dcLinkMan=CZQThostFtdcLinkManField
dcQryLinkMan=CZQThostFtdcQryLinkManField
dcRspFutureSignOut=CZQThostFtdcRspFutureSignOutField
dcReqOpenAccount=CZQThostFtdcReqOpenAccountField
dcLoginInfo=CZQThostFtdcLoginInfoField
dcErrOrder=CZQThostFtdcErrOrderField
dcCFMMCBrokerKey=CZQThostFtdcCFMMCBrokerKeyField
dcTradingNotice=CZQThostFtdcTradingNoticeField
dcTransferBankToFutureRsp=CZQThostFtdcTransferBankToFutureRspField
dcQryInstrumentStatus=CZQThostFtdcQryInstrumentStatusField
dcQryInvestorPosition=CZQThostFtdcQryInvestorPositionField
dcQryTradingAccount=CZQThostFtdcQryTradingAccountField
dcBrokerSync=CZQThostFtdcBrokerSyncField
dcQueryBrokerDeposit=CZQThostFtdcQueryBrokerDepositField
dcExchangeMarginRate=CZQThostFtdcExchangeMarginRateField
dcSettlementInfoConfirm=CZQThostFtdcSettlementInfoConfirmField
dcTrader=CZQThostFtdcTraderField
dcQryBrokerUserFunction=CZQThostFtdcQryBrokerUserFunctionField
dcPositionProfitAlgorithm=CZQThostFtdcPositionProfitAlgorithmField
dcMarketDataAsk45=CZQThostFtdcMarketDataAsk45Field
dcTransferFutureToBankReq=CZQThostFtdcTransferFutureToBankReqField
dcInstrumentStatus=CZQThostFtdcInstrumentStatusField
dcQrySuperUser=CZQThostFtdcQrySuperUserField
dcMarketDataBid45=CZQThostFtdcMarketDataBid45Field
dcBrokerUserFunction=CZQThostFtdcBrokerUserFunctionField
dcForceUserLogout=CZQThostFtdcForceUserLogoutField
dcQryTraderOffer=CZQThostFtdcQryTraderOfferField
dcQryCFMMCBrokerKey=CZQThostFtdcQryCFMMCBrokerKeyField
dcQryInstrumentMarginRate=CZQThostFtdcQryInstrumentMarginRateField
dcRspSyncKey=CZQThostFtdcRspSyncKeyField
dcVerifyFuturePassword=CZQThostFtdcVerifyFuturePasswordField
dcSyncingInstrumentMarginRate=CZQThostFtdcSyncingInstrumentMarginRateField
dcParkedOrderAction=CZQThostFtdcParkedOrderActionField
dcBrokerUserOTPParam=CZQThostFtdcBrokerUserOTPParamField
dcQryInstrumentCommissionRate=CZQThostFtdcQryInstrumentCommissionRateField
dcMDTraderOffer=CZQThostFtdcMDTraderOfferField
dcQueryMaxOrderVolumeWithPrice=CZQThostFtdcQueryMaxOrderVolumeWithPriceField
dcCommPhase=CZQThostFtdcCommPhaseField
dcSuperUserFunction=CZQThostFtdcSuperUserFunctionField
dcTransferFutureToBankRsp=CZQThostFtdcTransferFutureToBankRspField
dcMarketData=CZQThostFtdcMarketDataField
dcSyncingTradingAccount=CZQThostFtdcSyncingTradingAccountField
dcFrontStatus=CZQThostFtdcFrontStatusField
dcCombinationLeg=CZQThostFtdcCombinationLegField
dcQryErrOrderAction=CZQThostFtdcQryErrOrderActionField
dcQryExchangeOrderAction=CZQThostFtdcQryExchangeOrderActionField
dcSyncingTradingCode=CZQThostFtdcSyncingTradingCodeField
dcInstrumentTradingRight=CZQThostFtdcInstrumentTradingRightField
dcInvestorPositionDetail=CZQThostFtdcInvestorPositionDetailField
dcContractBank=CZQThostFtdcContractBankField
dcQryTransferSerial=CZQThostFtdcQryTransferSerialField
dcManualSyncBrokerUserOTP=CZQThostFtdcManualSyncBrokerUserOTPField
dcInvestorAccount=CZQThostFtdcInvestorAccountField
dcQryOrderAction=CZQThostFtdcQryOrderActionField
dcUserSession=CZQThostFtdcUserSessionField
dcQryBrokerTradingAlgos=CZQThostFtdcQryBrokerTradingAlgosField
dcQrySuperUserFunction=CZQThostFtdcQrySuperUserFunctionField
dcMarketDataStatic=CZQThostFtdcMarketDataStaticField
dcDiscount=CZQThostFtdcDiscountField
dcUserIP=CZQThostFtdcUserIPField
dcQryBrokerUser=CZQThostFtdcQryBrokerUserField
dcReqQueryAccount=CZQThostFtdcReqQueryAccountField
dcQryHisOrder=CZQThostFtdcQryHisOrderField
dcInstrumentCommissionRate=CZQThostFtdcInstrumentCommissionRateField
dcBrokerUser=CZQThostFtdcBrokerUserField
dcSyncDeposit=CZQThostFtdcSyncDepositField
dcQryInstrumentTradingRight=CZQThostFtdcQryInstrumentTradingRightField
dcQryCFMMCTradingAccountKey=CZQThostFtdcQryCFMMCTradingAccountKeyField
dcNotice=CZQThostFtdcNoticeField
dcReqTransfer=CZQThostFtdcReqTransferField
dcErrOrderAction=CZQThostFtdcErrOrderActionField
dcNotifyFutureSignIn=CZQThostFtdcNotifyFutureSignInField
dcQryInvestor=CZQThostFtdcQryInvestorField
dcQryNotice=CZQThostFtdcQryNoticeField
dcQrySyncDeposit=CZQThostFtdcQrySyncDepositField
dcUserRight=CZQThostFtdcUserRightField
dcQueryMaxOrderVolume=CZQThostFtdcQueryMaxOrderVolumeField
dcExchangeTrade=CZQThostFtdcExchangeTradeField
dcFutureSignIO=CZQThostFtdcFutureSignIOField
dcInputOrderAction=CZQThostFtdcInputOrderActionField
dcTransferQryDetailRsp=CZQThostFtdcTransferQryDetailRspField
dcExchange=CZQThostFtdcExchangeField
dcTransferQryBankReq=CZQThostFtdcTransferQryBankReqField
dcTransferBankToFutureReq=CZQThostFtdcTransferBankToFutureReqField
dcQryUserSession=CZQThostFtdcQryUserSessionField
dcExchangeMarginRateAdjust=CZQThostFtdcExchangeMarginRateAdjustField
dcRspAuthenticate=CZQThostFtdcRspAuthenticateField
dcQryTradingCode=CZQThostFtdcQryTradingCodeField
dcMarketDataLastMatch=CZQThostFtdcMarketDataLastMatchField
dcMarketDataExchange=CZQThostFtdcMarketDataExchangeField
dcDissemination=CZQThostFtdcDisseminationField
dcRemoveParkedOrder=CZQThostFtdcRemoveParkedOrderField
dcQryOrder=CZQThostFtdcQryOrderField
dcSyncingInstrumentTradingRight=CZQThostFtdcSyncingInstrumentTradingRightField
dcMarketDataBestPrice=CZQThostFtdcMarketDataBestPriceField
dcTransferHeader=CZQThostFtdcTransferHeaderField
dcQrySettlementInfoConfirm=CZQThostFtdcQrySettlementInfoConfirmField
dcReqCancelAccount=CZQThostFtdcReqCancelAccountField
dcQryInstrument=CZQThostFtdcQryInstrumentField
dcReturnResult=CZQThostFtdcReturnResultField
dcVerifyFuturePasswordAndCustInfo=CZQThostFtdcVerifyFuturePasswordAndCustInfoField
dcReqFutureSignOut=CZQThostFtdcReqFutureSignOutField
dcUserPasswordUpdate=CZQThostFtdcUserPasswordUpdateField
dcTradingCode=CZQThostFtdcTradingCodeField
dcReqUserLogin=CZQThostFtdcReqUserLoginField
dcSyncingInstrumentCommissionRate=CZQThostFtdcSyncingInstrumentCommissionRateField
dcSpecificInstrument=CZQThostFtdcSpecificInstrumentField
dcQryErrOrder=CZQThostFtdcQryErrOrderField
dcSuperUser=CZQThostFtdcSuperUserField
dcTradingAccountPassword=CZQThostFtdcTradingAccountPasswordField
dcLogoutAll=CZQThostFtdcLogoutAllField
dcOrder=CZQThostFtdcOrderField
dcReqChangeAccount=CZQThostFtdcReqChangeAccountField
dcQryFrontStatus=CZQThostFtdcQryFrontStatusField
dcMaxStockPositionAmount=CZQThostFtdcMaxStockPositionAmountField
dcNotifyFutureSignOut=CZQThostFtdcNotifyFutureSignOutField
dcQryInvestorPositionCombineDetail=CZQThostFtdcQryInvestorPositionCombineDetailField
dcBrokerWithdrawAlgorithm=CZQThostFtdcBrokerWithdrawAlgorithmField
dcProduct=CZQThostFtdcProductField
dcExchangeOrder=CZQThostFtdcExchangeOrderField
dcRemoveParkedOrderAction=CZQThostFtdcRemoveParkedOrderActionField
dcCurrentTime=CZQThostFtdcCurrentTimeField
dcQryTrade=CZQThostFtdcQryTradeField
dcSettlementInfo=CZQThostFtdcSettlementInfoField
dcDepthMarketData=CZQThostFtdcDepthMarketDataField
dcReqSyncKey=CZQThostFtdcReqSyncKeyField
dcRspTransfer=CZQThostFtdcRspTransferField
dcPartBroker=CZQThostFtdcPartBrokerField
dcQryTrader=CZQThostFtdcQryTraderField
dcTransferQryBankRsp=CZQThostFtdcTransferQryBankRspField
dcExchangeOrderAction=CZQThostFtdcExchangeOrderActionField
dcNotifyQueryAccount=CZQThostFtdcNotifyQueryAccountField
dcRspQueryAccount=CZQThostFtdcRspQueryAccountField
dcLoadSettlementInfo=CZQThostFtdcLoadSettlementInfoField
dcTradingAccountPasswordUpdateV1=CZQThostFtdcTradingAccountPasswordUpdateV1Field
dcRspRepeal=CZQThostFtdcRspRepealField
dcQryParkedOrderAction=CZQThostFtdcQryParkedOrderActionField
dcDepositResultInform=CZQThostFtdcDepositResultInformField
dcQryProduct=CZQThostFtdcQryProductField
dcQryExchangeOrder=CZQThostFtdcQryExchangeOrderField
dcReqAuthenticate=CZQThostFtdcReqAuthenticateField
dcQryExchangeSequence=CZQThostFtdcQryExchangeSequenceField
dcParkedOrder=CZQThostFtdcParkedOrderField
dcMarketDataAveragePrice=CZQThostFtdcMarketDataAveragePriceField
dcMarketDataBid23=CZQThostFtdcMarketDataBid23Field
dcTradingNoticeInfo=CZQThostFtdcTradingNoticeInfoField
dcExchangeOrderActionError=CZQThostFtdcExchangeOrderActionErrorField
dcTradingAccountPasswordUpdate=CZQThostFtdcTradingAccountPasswordUpdateField
dcSettlementRef=CZQThostFtdcSettlementRefField
dcMarketDataUpdateTime=CZQThostFtdcMarketDataUpdateTimeField
dcTraderOffer=CZQThostFtdcTraderOfferField
dcRspInfo=CZQThostFtdcRspInfoField
dcExchangeSequence=CZQThostFtdcExchangeSequenceField
dcRspUserLogin=CZQThostFtdcRspUserLoginField
dcBrokerDeposit=CZQThostFtdcBrokerDepositField
dcQryCombinationLeg=CZQThostFtdcQryCombinationLegField
dcReqQueryTradeResultBySerial=CZQThostFtdcReqQueryTradeResultBySerialField
dcQryBrokerTradingParams=CZQThostFtdcQryBrokerTradingParamsField
dcInstrument=CZQThostFtdcInstrumentField
dcSyncingInvestorPosition=CZQThostFtdcSyncingInvestorPositionField
dcTransferQryDetailReq=CZQThostFtdcTransferQryDetailReqField
dcInstrumentMarginRateAdjust=CZQThostFtdcInstrumentMarginRateAdjustField
dcQryContractBank=CZQThostFtdcQryContractBankField
dcInvestorPosition=CZQThostFtdcInvestorPositionField
dcBrokerUserPassword=CZQThostFtdcBrokerUserPasswordField
dcBrokerTradingAlgos=CZQThostFtdcBrokerTradingAlgosField
dcInstrumentMarginRate=CZQThostFtdcInstrumentMarginRateField
dcVerifyCustInfo=CZQThostFtdcVerifyCustInfoField
dcInputOrder=CZQThostFtdcInputOrderField
dcErrorConditionalOrder=CZQThostFtdcErrorConditionalOrderField
dcNotifySyncKey=CZQThostFtdcNotifySyncKeyField
dcSyncStatus=CZQThostFtdcSyncStatusField
dcSyncingInvestorGroup=CZQThostFtdcSyncingInvestorGroupField
dcMarketDataBase=CZQThostFtdcMarketDataBaseField
dcInvestorPositionCombineDetail=CZQThostFtdcInvestorPositionCombineDetailField
dcQryInvestorGroup=CZQThostFtdcQryInvestorGroupField
dcQryTransferBank=CZQThostFtdcQryTransferBankField
dcQryMDTraderOffer=CZQThostFtdcQryMDTraderOfferField
dcMarketDataAsk23=CZQThostFtdcMarketDataAsk23Field
dcBroker=CZQThostFtdcBrokerField
dcExchangeOrderInsertError=CZQThostFtdcExchangeOrderInsertErrorField
dcInvestor=CZQThostFtdcInvestorField
dcQryDepthMarketData=CZQThostFtdcQryDepthMarketDataField
dcInvestorGroup=CZQThostFtdcInvestorGroupField
dcQryPartBroker=CZQThostFtdcQryPartBrokerField
