...
class CThostFtdcCancelAccountField:
    ...
    def __repr__(self): return "<%s>" % ",".join(["%s:%s" % (x, getattr(self, x)) for x in ['MoneyAccountStatus', 'BrokerBranchID', 'BankPassWord', 'Telephone', 'TradeTime', 'VerifyCertNoFlag', 'TID', 'AccountID', 'BankAccount', 'Fax', 'InstallID', 'CustomerName', 'CountryCode', 'TradeCode', 'BankSecuAcc', 'BankBranchID', 'SessionID', 'Address', 'PlateSerial', 'BankPwdFlag', 'ErrorID', 'CustType', 'IdentifiedCardNo', 'BankID', 'BankSerial', 'OperNo', 'TradingDay', 'Gender', 'BrokerID', 'CashExchangeCode', 'IdCardType', 'Password', 'MobilePhone', 'TradeDate', 'CurrencyID', 'ErrorMsg', 'BankAccType', 'LastFragment', 'ZipCode', 'BankSecuAccType', 'BrokerIDByBank', 'SecuPwdFlag', 'EMail', 'Digest', 'DeviceID']])
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('MoneyAccountStatus', u'资金账户状态'),('BrokerBranchID', u'期商分支机构代码'),('BankPassWord', u'银行密码'),('Telephone', u'电话号码'),('TradeTime', u'交易时间'),('VerifyCertNoFlag', u'验证客户证件号码标志'),('TID', u'交易ID'),('AccountID', u'投资者帐号'),('BankAccount', u'银行帐号'),('Fax', u'传真'),('InstallID', u'安装编号'),('CustomerName', u'客户姓名'),('CountryCode', u'国家代码'),('TradeCode', u'业务功能码'),('BankSecuAcc', u'期货单位帐号'),('BankBranchID', u'银行分支机构代码'),('SessionID', u'会话号'),('Address', u'地址'),('PlateSerial', u'银期平台消息流水号'),('BankPwdFlag', u'银行密码标志'),('ErrorID', u'错误代码'),('CustType', u'客户类型'),('IdentifiedCardNo', u'证件号码'),('BankID', u'银行代码'),('BankSerial', u'银行流水号'),('OperNo', u'交易柜员'),('TradingDay', u'交易系统日期'),('Gender', u'性别'),('BrokerID', u'期商代码'),('CashExchangeCode', u'汇钞标志'),('IdCardType', u'证件类型'),('Password', u'期货密码'),('MobilePhone', u'手机'),('TradeDate', u'交易日期'),('CurrencyID', u'币种代码'),('ErrorMsg', u'错误信息'),('BankAccType', u'银行帐号类型'),('LastFragment', u'最后分片标志'),('ZipCode', u'邮编'),('BankSecuAccType', u'期货单位帐号类型'),('BrokerIDByBank', u'期货公司银行编码'),('SecuPwdFlag', u'期货资金密码核对标志'),('EMail', u'电子邮件'),('Digest', u'摘要'),('DeviceID', u'渠道标志')]])
    def getval(self, n):
...
class CThostFtdcChangeAccountField:
    def __init__(self, MoneyAccountStatus='0', NewBankPassWord="", BrokerBranchID="", BankPassWord="", Telephone="", TradeTime="", VerifyCertNoFlag='0', TID=0, AccountID="", BankAccount="", Fax="", InstallID=0, CustomerName="", CountryCode="", TradeCode="", BankBranchID="", SessionID=0, NewBankAccount="", Address="", PlateSerial=0, BankPwdFlag='0', ErrorID=0, CustType='0', IdentifiedCardNo="", BankID="", BankSerial="", TradingDay="", Gender='0', BrokerID="", IdCardType='0', Password="", MobilePhone="", TradeDate="", CurrencyID="", ErrorMsg="", BankAccType='1', LastFragment='0', ZipCode="", BrokerIDByBank="", SecuPwdFlag='0', EMail="", Digest=""):
        self.MoneyAccountStatus=MoneyAccountStatus
        self.NewBankPassWord=NewBankPassWord
        self.BrokerBranchID=BrokerBranchID
        self.BankPassWord=BankPassWord
        ...
        self.Digest=Digest
        self.vcmap={'CustType': {"'1'": u'\u673a\u6784\u6237', "'0'": u'\u81ea\u7136\u4eba'}, 'Gender': {"'1'": u'\u7537', "'2'": u'\u5973', "'0'": u'\u672a\u77e5\u72b6\u6001'}, 'BankPwdFlag': {"'1'": u'\u660e\u6587\u6838\u5bf9', "'2'": u'\u5bc6\u6587\u6838\u5bf9', "'0'": u'\u4e0d\u6838\u5bf9'}, 'LastFragment': {"'1'": u'\u4e0d\u662f\u6700\u540e\u5206\u7247', "'0'": u'\u662f\u6700\u540e\u5206\u7247'}, 'MoneyAccountStatus': {"'1'": u'\u9500\u6237', "'0'": u'\u6b63\u5e38'}, 'SecuPwdFlag': {"'1'": u'\u660e\u6587\u6838\u5bf9', "'2'": u'\u5bc6\u6587\u6838\u5bf9', "'0'": u'\u4e0d\u6838\u5bf9'}, 'VerifyCertNoFlag': {"'1'": u'\u5426', "'0'": u'\u662f'}, 'BankAccType': {"'1'": u'\u94f6\u884c\u5b58\u6298', "'2'": u'\u50a8\u84c4\u5361', "'3'": u'\u4fe1\u7528\u5361'}, 'IdCardType': {"'9'": u'\u8425\u4e1a\u6267\u7167\u53f7', "'7'": u'\u53f0\u80de\u8bc1', "'x'": u'\u5176\u4ed6\u8bc1\u4ef6', "'5'": u'\u6237\u53e3\u7c3f', "'4'": u'\u58eb\u5175\u8bc1', "'1'": u'\u8eab\u4efd\u8bc1', "'0'": u'\u7ec4\u7ec7\u673a\u6784\u4ee3\u7801', "'6'": u'\u62a4\u7167', "'2'": u'\u519b\u5b98\u8bc1', "'8'": u'\u56de\u4e61\u8bc1', "'3'": u'\u8b66\u5b98\u8bc1', "'A'": u'\u7a0e\u52a1\u767b\u8bb0\u53f7'}}
    def __repr__(self): return "<%s>" % ",".join(["%s:%s" % (x, getattr(self, x)) for x in ['MoneyAccountStatus', 'NewBankPassWord', 'BrokerBranchID', 'BankPassWord', 'Telephone', 'TradeTime', 'VerifyCertNoFlag', 'TID', 'AccountID', 'BankAccount', 'Fax', 'InstallID', 'CustomerName', 'CountryCode', 'TradeCode', 'BankBranchID', 'SessionID', 'NewBankAccount', 'Address', 'PlateSerial', 'BankPwdFlag', 'ErrorID', 'CustType', 'IdentifiedCardNo', 'BankID', 'BankSerial', 'TradingDay', 'Gender', 'BrokerID', 'IdCardType', 'Password', 'MobilePhone', 'TradeDate', 'CurrencyID', 'ErrorMsg', 'BankAccType', 'LastFragment', 'ZipCode', 'BrokerIDByBank', 'SecuPwdFlag', 'EMail', 'Digest']])
    def __str__(self):  return "<%s>" % ",".join(["%s:%s" % (y, self.getval(x)) for x,y in [('MoneyAccountStatus', u'资金账户状态'),('NewBankPassWord', u'新银行密码'),('BrokerBranchID', u'期商分支机构代码'),('BankPassWord', u'银行密码'),('Telephone', u'电话号码'),('TradeTime', u'交易时间'),('VerifyCertNoFlag', u'验证客户证件号码标志'),('TID', u'交易ID'),('AccountID', u'投资者帐号'),('BankAccount', u'银行帐号'),('Fax', u'传真'),('InstallID', u'安装编号'),('CustomerName', u'客户姓名'),('CountryCode', u'国家代码'),('TradeCode', u'业务功能码'),('BankBranchID', u'银行分支机构代码'),('SessionID', u'会话号'),('NewBankAccount', u'新银行帐号'),('Address', u'地址'),('PlateSerial', u'银期平台消息流水号'),('BankPwdFlag', u'银行密码标志'),('ErrorID', u'错误代码'),('CustType', u'客户类型'),('IdentifiedCardNo', u'证件号码'),('BankID', u'银行代码'),('BankSerial', u'银行流水号'),('TradingDay', u'交易系统日期'),('Gender', u'性别'),('BrokerID', u'期商代码'),('IdCardType', u'证件类型'),('Password', u'期货密码'),('MobilePhone', u'手机'),('TradeDate', u'交易日期'),('CurrencyID', u'币种代码'),('ErrorMsg', u'错误信息'),('BankAccType', u'银行帐号类型'),('LastFragment', u'最后分片标志'),('ZipCode', u'邮编'),('BrokerIDByBank', u'期货公司银行编码'),('SecuPwdFlag', u'期货资金密码核对标志'),('EMail', u'电子邮件'),('Digest', u'摘要')]])
    def getval(self, n):
        if n in ['MoneyAccountStatus', 'VerifyCertNoFlag', 'BankPwdFlag', 'CustType', 'Gender', 'IdCardType', 'BankAccType', 'LastFragment', 'SecuPwdFlag']:
            return self.vcmap[n][getattr(self, n)].encode("utf-8")
        else: return getattr(self, n)
